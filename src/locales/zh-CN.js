export default {
  ...
  'app.login.tab-login-credentials': '账户登录',
  'app.login.tab-login-mobile': '手机登录',
  'app.login.tab-login-usbkey': '加密锁登陆',
  'app.login.tab-login-qrcode': '二维码登陆',
